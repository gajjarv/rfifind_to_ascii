...
"""
"""
Example: python rfi_filter.py -fil GBT_Lband_PSR.fil -time 30.0 -timesig 10.0 -freqsig 4.0 -chanfrac 0.7 -intfrac 0.3 -max_percent 20.0 -mask 
"""
from argparse import ArgumentParser
import os
import rfi_quality_check as rfiqul
import timeit
import sys

def rfi_filter(fil_file, time, timesig, freqsig, chanfrac, intfrac, max_percent, mask):
...
if __name__ == "__main__":
	...
	parser.add_argument("-mask", action='store', dest='mask',required=False,default="",type=str,
	...
	rfi_filter(fil_file, time, timesig, freqsig, chanfrac, intfrac, max_percent, mask)
